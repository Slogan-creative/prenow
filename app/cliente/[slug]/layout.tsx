...
export async function generateMetadata({params}:{params:Promise<{slug:string}>}):Promise<Metadata>{const {slug}=await params;return {manifest:`/cliente/${encodeURIComponent(slug)}/manifest.webmanifest`};}
